...
In this sample project we wnat to configure both Http client and server to use secure connections with SSL. First we need a keystore that holds the
...
a complete [reference manual][3].
 ...
 [4]: http://www.citrusframework.org/reference/html/index.html#http
